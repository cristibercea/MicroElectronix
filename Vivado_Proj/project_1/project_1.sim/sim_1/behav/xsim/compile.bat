...
REM
REM Generated by Vivado on Mon Aug 08 16:38:52 +0300 2022
...
echo "xvlog --incr --relax -prj adder_tb_vlog.prj"
call xvlog  --incr --relax -prj adder_tb_vlog.prj -log xvlog.log
